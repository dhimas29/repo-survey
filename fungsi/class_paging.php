...
class PagingKuis{
	...
	function navHalaman($halaman_aktif, $jmlhalaman){
		...
		for ($i=1; $i<=$jmlhalaman; $i++){
			if ($i == $halaman_aktif){
				$link_halaman .= "<li class='active'><a href='$_SERVER[PHP_SELF]?module=kuisioner'>$i</a></li>  ";
			}
			else{
				$link_halaman .= "<li><a href='$_SERVER[PHP_SELF]?module=kuisioner&halaman=$i'>$i</a> </li>";
			}
			$link_halaman .= " ";
		}
		return $link_halaman;
...
class PagingKlien{
	...
	function navHalaman($halaman_aktif, $jmlhalaman){
		...
		for ($i=1; $i<=$jmlhalaman; $i++){
			if ($i == $halaman_aktif){
				$link_halaman .= "<li class='active'><a href='$_SERVER[PHP_SELF]?module=klien'>$i</a></li>  ";
			}
			else{
				$link_halaman .= "<li><a href='$_SERVER[PHP_SELF]?module=klien&halaman=$i'>$i</a> </li>";
			}
			$link_halaman .= " ";
		}
		return $link_halaman;
