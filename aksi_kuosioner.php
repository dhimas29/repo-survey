...
elseif (empty($companyFax)){
	...
	mysqli_query($hore,"INSERT INTO tcompany(companyId,companyName,companyAddress,companyPhoneHP,dateSurvey,suggestion,product)
	...
	while($data = mysqli_fetch_array($sql)){
		...
		while ($r = mysqli_fetch_array($hasil)){
			...
			// echo "$i $asfa<br>";
			if ($asfa == 'A'){
				mysqli_query($hore,"INSERT INTO tanswer (descriptionId,groupId,companyId,jawaban,jawabanA,jawabanB,jawabanC,jawabanD,jawabanE) 
			...
			if ($asf == 'A'){
				mysqli_query($hore,"INSERT INTO tanswer2 (descriptionId,groupId,companyId,jawaban,jawabanA,jawabanB,jawabanC,jawabanD,jawabanE) 
				VALUES('$r[descriptionId]','$r[groupId]','$companyId','$asf','1','0','0','0','0')");
			}	
			elseif($asf == 'B'){
				mysqli_query($hore,"INSERT INTO tanswer2 (descriptionId,groupId,companyId,jawaban,jawabanA,jawabanB,jawabanC,jawabanD,jawabanE) 
				VALUES('$r[descriptionId]','$r[groupId]','$companyId','$asf','0','1','0','0','0')");
			}
			elseif($asf == 'C'){
				mysqli_query($hore,"INSERT INTO tanswer2 (descriptionId,groupId,companyId,jawaban,jawabanA,jawabanB,jawabanC,jawabanD,jawabanE) 
				VALUES('$r[descriptionId]','$r[groupId]','$companyId','$asf','0','0','1','0','0')");
			}
			elseif($asf == 'D'){
				mysqli_query($hore,"INSERT INTO tanswer2 (descriptionId,groupId,companyId,jawaban,jawabanA,jawabanB,jawabanC,jawabanD,jawabanE) 
				VALUES('$r[descriptionId]','$r[groupId]','$companyId','$asf','0','0','0','1','0')");
			}
			else{
				mysqli_query($hore,"INSERT INTO tanswer2 (descriptionId,groupId,companyId,jawaban,jawabanA,jawabanB,jawabanC,jawabanD,jawabanE) 
				VALUES('$r[descriptionId]','$r[groupId]','$companyId','$asf','0','0','0','0','1')");
			}
			$i++;
		}
		echo "<br>";
