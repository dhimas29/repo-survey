...
switch($_GET[act]){
	...
	<div class="row">
	    <div class="col-lg-12">
	        ...
	        <ol class="breadcrumb">
	            <li class="active">
	                 <a href="master.php?module=group">Manajemen Dimensi</a>
	            </li>
	        </ol>
	    </div>
	</div>
	<div class="panel panel-primary">
		<div class="panel-heading">
			...
			<div class="panel-title"><span class="glyphicon glyphicon-list"></span> Manajemen Dimensi <i style="margin-left:700px;"><?php if($_SESSION['level']=="Super"){?><button class="btn btn-success btn-sm " onclick="window.location.href='?module=group&act=tambahgroup'"><span class="glyphicon glyphicon-plus"></span> Tambah Dimensi</button></i><?php } ?></div>
		</div>
			...
			<table id="tablekonten" class="table table-striped table-bordered table-responsive" style="">
				...
				<tbody>
					<?php 
					    ...
					    $tampil = mysqli_query($hore,"SELECT * FROM tgroup order by groupName asc limit $posisi,$batas");
					    $no =$posisi+1;
